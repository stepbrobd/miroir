...
require (
	...
	github.com/sourcegraph/zoekt v0.0.0-20260429093855-b78f6ddf68e4
...
require (
	...
	github.com/sourcegraph/go-ctags v0.0.0-20260429093619-034adb2f9fec // indirect
